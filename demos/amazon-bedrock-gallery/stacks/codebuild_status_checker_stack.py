...
class CodeBuildStatusCheckerStack(Stack):
    def __init__(self, scope: Construct, construct_id: str, codebuild_projects: list, **kwargs) -> None:
        ...
        status_checker_lambda = lambda_.Function(self, "CodeBuildStatusChecker",
            runtime=lambda_.Runtime.PYTHON_3_9,
            handler="index.handler",
            code=lambda_.Code.from_asset("lambda/codebuild_status_checker"),
        ...
        custom_resource = CustomResource(self, "CodeBuildStatusResource",
            service_token=cr.Provider(self, "CodeBuildStatusProvider",
